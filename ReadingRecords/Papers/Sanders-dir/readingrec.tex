...
% dev propose : different modeles de la meme transition ; transition a cheval sur deux periodes avec chacune ses specialistes
% interaction info/shs pour reposer des questions fondamentales (//geodivercity).

% annexe 1 : thematicien, difficulte d'entrer dans monde modelisation. frustration du thematicien de devoir simplifier, mettre des donnees de cote.
% annexe 2 : les sma comme outil de modelisation - perd les matheux ; avantage des sma : agents heterogenes, multi niveau etc. 
% annexe 3 : Arnaud, description des types de modelisateurs.
